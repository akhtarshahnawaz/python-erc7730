...
def test_roundtrip_from_legacy_eip712(input_file: Path) -> None:
    ...
    erc7730_descriptor = convert_and_print_errors(input_legacy_eip712_descriptor, EIP712toERC7730Converter())
    assert erc7730_descriptor is not None
    output_legacy_eip712_descriptor = convert_and_print_errors(erc7730_descriptor, ERC7730toEIP712Converter())
